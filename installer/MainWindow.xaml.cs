...
public partial class MainWindow : Window {
    ...
    public MainWindow() {
        ...
        if (!resources.Any(r => r == "HorizonLauncher.exe")) {
            MessageBox.Show(
                "Error: HorizonLauncher.exe is not embedded in this installer.\n\n" +
                "Make sure you:\n" +
    ...
    private async void Install_Click(object sender, RoutedEventArgs e) {
        ...
        try {
            ...
            if (RunAfterInstallCheckBox.IsChecked == true) {
                var launcherPath = Path.Combine(_installPath, "HorizonLauncher.exe");
    ...
    private void PerformInstallation() {
        ...
        UpdateProgress("Extracting HorizonLauncher.exe...", 20);
        
        // Extract embedded HorizonLauncher.exe
        ExtractEmbeddedResource("HorizonLauncher.exe", Path.Combine(_installPath, "HorizonLauncher.exe"));
    ...
    private void CreateDesktopShortcut() {
        try {
            ...
            var shortcutPath = Path.Combine(desktopPath, "Horizon Launcher.lnk");
            var targetPath = Path.Combine(_installPath, "HorizonLauncher.exe");
            ...
            var psCommand = $@"
                ...
                $Shortcut.Description = 'Horizon Launcher'
                $Shortcut.Save()
            ";
