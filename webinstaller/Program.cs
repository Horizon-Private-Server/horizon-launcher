...
public class InstallerWindow : Window {
    private const string GitHubUser = "Horizon-Private-Server";
    private const string GitHubRepo = "horizon-launcher";
    ...
    public InstallerWindow() {
        // Window properties
        Title = "Horizon Launcher - Web Installer";
        Width = 500;
        Height = 300;
    ...
    private UIElement CreateUI() {
        ...
        var title = new TextBlock {
            Text = "Horizon Launcher Web Installer",
            FontSize = 20,
        ...
        var description = new TextBlock {
            Text = "This will download the latest Horizon Launcher installer\nfrom GitHub and run it.",
            FontSize = 13,
