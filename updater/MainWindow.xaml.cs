...
namespace HorizonLauncherUpdater;
...
public partial class MainWindow : Window
{
    ...
    private async Task PerformUpdate()
    {
        try
        {
            ...
            var processes = Process.GetProcessesByName("HorizonLauncher");
    ...
    private void ExtractEmbeddedFiles()
    {
        ...
        foreach (var resource in resources)
        {
            ...
            // Handle launcher EXE (logical name is exactly "HorizonLauncher.exe")
            if (resource == "HorizonLauncher.exe")
            {
                outputPath = Path.Combine(_installPath, "HorizonLauncher.exe.new");
            }
    ...
    {
        var newPath = Path.Combine(_installPath, "HorizonLauncher.exe.new");
        var oldPath = Path.Combine(_installPath, "HorizonLauncher.exe");
        var backupPath = Path.Combine(_installPath, "HorizonLauncher.exe.old");
